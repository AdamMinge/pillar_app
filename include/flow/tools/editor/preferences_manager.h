...
public:
  ...
  void addRecentDocumentFile(const QString& recent_file);
  void clearRecentDocumentFiles();
  [[nodiscard]] QStringList getRecentDocumentFiles() const;
...
Q_SIGNALS:
  void recentDocumentFilesChanged();
...
private:
  ...
  QStringList m_recent_document_files;
};
