...
#ifndef FLOW_QTBUTTONPROPERTYBROWSER_H
#define FLOW_QTBUTTONPROPERTYBROWSER_H
...
class TOOLS_SHARED_API QtButtonPropertyBrowser : public QtAbstractPropertyBrowser
{
    Q_OBJECT
public:
