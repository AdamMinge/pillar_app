...
#ifndef FLOW_QTVARIANTPROPERTY_H
#define FLOW_QTVARIANTPROPERTY_H
...
class TOOLS_SHARED_API QtVariantProperty : public QtProperty
{
public:
    ~QtVariantProperty();
...
class TOOLS_SHARED_API QtVariantPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class TOOLS_SHARED_API QtVariantEditorFactory : public QtAbstractEditorFactory<QtVariantPropertyManager>
{
    Q_OBJECT
public:
...
Q_DECLARE_METATYPE(tools::QtIconMap)
#endif
