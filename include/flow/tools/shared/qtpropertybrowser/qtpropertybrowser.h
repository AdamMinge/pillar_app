...
#ifndef FLOW_QTPROPERTYBROWSER_H
#define FLOW_QTPROPERTYBROWSER_H
...
class TOOLS_SHARED_API QtProperty
{
public:
    virtual ~QtProperty();
...
class TOOLS_SHARED_API QtAbstractPropertyManager : public QObject
{
    Q_OBJECT
public:
...
class TOOLS_SHARED_API QtAbstractEditorFactoryBase : public QObject
{
    Q_OBJECT
public:
...
class TOOLS_SHARED_API QtAbstractEditorFactory : public QtAbstractEditorFactoryBase
{
public:
...
class TOOLS_SHARED_API QtBrowserItem
{
public:
...
class TOOLS_SHARED_API QtAbstractPropertyBrowser : public QWidget
{
    Q_OBJECT
public:
