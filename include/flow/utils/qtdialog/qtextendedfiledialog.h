#ifndef FLOW_TOOLS_EXTENDED_FILE_DIALOG_H
#define FLOW_TOOLS_EXTENDED_FILE_DIALOG_H
...
namespace utils
{
  ...
  class QTDIALOG_API QtExtendedFileDialog : public QFileDialog
  {
    Q_OBJECT
...
#endif//FLOW_TOOLS_EXTENDED_FILE_DIALOG_H
