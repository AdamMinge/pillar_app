#ifndef UTILS_WIDGET_NAME_AND_PATH_FILLER_H
#define UTILS_WIDGET_NAME_AND_PATH_FILLER_H

/* ------------------------------------ Qt ---------------------------------- */
#include <QDir>
#include <QWidget>
/* ----------------------------------- Local -------------------------------- */
#include "flow/utils/widget/export.h"
/* -------------------------------------------------------------------------- */
...
#endif  // UTILS_WIDGET_NAME_AND_PATH_FILLER_H
