#ifndef FLOW_ZIP_FILE_H
#define FLOW_ZIP_FILE_H
...
namespace utils
{
  ...
  class ARCHIVE_API QtZipFile : public QObject
  {
    Q_OBJECT

  public:
    static std::unique_ptr<QtZipFile> load(QString file_name,
                                           int compression_level = 6);
    static std::unique_ptr<QtZipFile> create(QString file_name,
                                             int compression_level = 6);
