...
#ifndef FLOW_PROPERTY_BROWSER_H
#define FLOW_PROPERTY_BROWSER_H

/* ------------------------------------ Qt ---------------------------------- */
#include <QtCore/QSet>
#include <QtWidgets/QWidget>
/* ----------------------------------- Local -------------------------------- */
#include "flow/utils/qt/property_browser/export.h"
/* -------------------------------------------------------------------------- */
...
namespace utils
{
  ...
  public:
    ...
    void addPropertyManager(PropertyManager *manager)
    {
      ...
      connect(
        manager, SIGNAL(destroyed(QObject *)), this,
  ...
  protected:
    ...
    virtual QWidget *createEditor(
      PropertyManager *manager, QtProperty *property, QWidget *parent) = 0;
  ...
  public Q_SLOTS:
    ...
    QtBrowserItem *
    insertProperty(QtProperty *property, QtProperty *afterProperty);
    void removeProperty(QtProperty *property);

  protected:
    virtual void
    itemInserted(QtBrowserItem *item, QtBrowserItem *afterItem) = 0;
