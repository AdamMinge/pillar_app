...
namespace utils
{
  ...
  class PROPERTY_BROWSER_API QtVariantPropertyManager : public QtAbstractPropertyManager
  {
    Q_OBJECT
  public:
  ...
  class PROPERTY_BROWSER_API QtVariantEditorFactory : public QtAbstractEditorFactory<QtVariantPropertyManager>
  {
    Q_OBJECT
  public:
