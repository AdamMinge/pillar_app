...
#ifndef FLOW_VARIANT_PROPERTY_H
#define FLOW_VARIANT_PROPERTY_H
...
namespace utils
{
  ...
  class PROPERTY_BROWSER_API QtVariantProperty : public QtProperty
  {
  public:
    ~QtVariantProperty();
  ...
  class PROPERTY_BROWSER_API QtVariantPropertyManager
  ...
  public:
    ...
    addProperty(int propertyType, const QString &name = QString());
    ...
    virtual QVariant
    attributeValue(const QtProperty *property, const QString &attribute) const;
  ...
  Q_SIGNALS:
    ...
    void attributeChanged(
      QtProperty *property, const QString &attribute, const QVariant &val);
  ...
  private:
    ...
    Q_PRIVATE_SLOT(
      d_func(), void slotValueChanged(QtProperty *, const QString &))
    Q_PRIVATE_SLOT(
      d_func(),
    ...
    Q_PRIVATE_SLOT(
      d_func(), void slotValueChanged(QtProperty *, const QDateTime &))
    Q_PRIVATE_SLOT(
    ...
    Q_PRIVATE_SLOT(
      d_func(), void slotValueChanged(QtProperty *, const QLocale &))
    Q_PRIVATE_SLOT(
      d_func(), void slotValueChanged(QtProperty *, const QPoint &))
    Q_PRIVATE_SLOT(
      d_func(), void slotValueChanged(QtProperty *, const QPointF &))
    ...
    Q_PRIVATE_SLOT(
      d_func(), void slotValueChanged(QtProperty *, const QSizeF &))
    Q_PRIVATE_SLOT(
      d_func(),
    ...
    Q_PRIVATE_SLOT(
      d_func(), void slotConstraintChanged(QtProperty *, const QRect &))
    Q_PRIVATE_SLOT(
      d_func(), void slotValueChanged(QtProperty *, const QRectF &))
    Q_PRIVATE_SLOT(
      d_func(), void slotConstraintChanged(QtProperty *, const QRectF &))
    Q_PRIVATE_SLOT(
      d_func(), void slotValueChanged(QtProperty *, const QColor &))
    Q_PRIVATE_SLOT(
    ...
    Q_PRIVATE_SLOT(
      d_func(), void slotValueChanged(QtProperty *, const QSizePolicy &))
    Q_PRIVATE_SLOT(d_func(), void slotValueChanged(QtProperty *, const QFont &))
    Q_PRIVATE_SLOT(
      d_func(), void slotValueChanged(QtProperty *, const QCursor &))
    Q_PRIVATE_SLOT(
      d_func(), void slotFlagNamesChanged(QtProperty *, const QStringList &))

    Q_PRIVATE_SLOT(
      d_func(),
      void slotPropertyInserted(QtProperty *, QtProperty *, QtProperty *))
    Q_PRIVATE_SLOT(
      d_func(), void slotPropertyRemoved(QtProperty *, QtProperty *))
    Q_DECLARE_PRIVATE(QtVariantPropertyManager)
    Q_DISABLE_COPY_MOVE(QtVariantPropertyManager)
  };

  class PROPERTY_BROWSER_API QtVariantEditorFactory
  ...
  protected:
    ...
    QWidget *createEditor(
      QtVariantPropertyManager *manager, QtProperty *property,
...
Q_DECLARE_METATYPE(utils::QtIconMap)
#endif
