...
class FLOATING_POINT_CONVERTER_API TypeConverter : public flow::PluginInterface
{
  Q_OBJECT
...
private:
  QScopedPointer<flow::node::TypeConverter> m_floating_point_to_boolean_converter;
  QScopedPointer<flow::node::TypeConverter> m_floating_point_to_integer_converter;
  QScopedPointer<flow::node::TypeConverter> m_floating_point_to_string_converter;
};
