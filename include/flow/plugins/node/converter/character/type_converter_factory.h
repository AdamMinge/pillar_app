...
class LOGIC_NODE_API CharacterConverterFactories : public flow::node::TypeConverterFactories
{
  Q_OBJECT
...
public:
  explicit CharacterConverterFactories();
  ~CharacterConverterFactories() override;
};
