...
class LOGIC_NODE_API IntegerConverterFactories : public flow::node::TypeConverterFactories
{
  Q_OBJECT
...
public:
  explicit IntegerConverterFactories();
  ~IntegerConverterFactories() override;
};
