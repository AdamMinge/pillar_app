...
class STRING_CONVERTER_API TypeConverter : public flow::PluginInterface
{
  Q_OBJECT
...
private:
  QScopedPointer<flow::node::TypeConverter> m_string_to_boolean_converter;
  QScopedPointer<flow::node::TypeConverter> m_string_to_floating_point_converter;
  QScopedPointer<flow::node::TypeConverter> m_string_to_integer_converter;
};
