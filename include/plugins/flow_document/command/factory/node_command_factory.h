#ifndef FLOW_DOCUMENT_NODE_COMMAND_FACTORY_H
#define FLOW_DOCUMENT_NODE_COMMAND_FACTORY_H
...
class FLOW_DOCUMENT_API NodeCommandFactory : public ObjectCommandFactory {
  Q_OBJECT
  Q_INTERFACES(flow_document::ObjectCommandFactory)

 public:
  explicit NodeCommandFactory(QObject* parent = nullptr);
  ~NodeCommandFactory() override;
...
#endif  // FLOW_DOCUMENT_NODE_COMMAND_FACTORY_H
