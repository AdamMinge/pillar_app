...
#define _DEFINE_ICON(NAME, SIZE, ICON) \
  constexpr QLatin1String NAME{":/plugins/flow/document/images/" SIZE "/" ICON};
...
#define _DEFINE_STYLE(NAME, STYLE) \
  constexpr QLatin1String NAME{":/plugins/flow/document/styles/" STYLE};
...
constexpr QLatin1String TranslationsPath{
    ":/plugins/flow/document/translations"};
