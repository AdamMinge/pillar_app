...
class LIB_FLOW_DOCUMENT_API SetLayersVisible : public ChangeValue<Layer, bool> {
 public:
...
class LIB_FLOW_DOCUMENT_API SetLayersLocked : public ChangeValue<Layer, bool> {
 public:
...
class LIB_FLOW_DOCUMENT_API SetLayersName : public ChangeValue<Layer, QString> {
 public:
...
class LIB_FLOW_DOCUMENT_API SetLayersOpacity
    : public ChangeValue<Layer, qreal> {
 public:
...
class LIB_FLOW_DOCUMENT_API SetLayersPosition
    : public ChangeValue<Layer, QPointF> {
 public:
...
class LIB_FLOW_DOCUMENT_API SetLayersCustomProperty
...
class LIB_FLOW_DOCUMENT_API AddRemoveLayersProperties : public pillar::Command {
 public:
...
class LIB_FLOW_DOCUMENT_API AddLayersProperties
...
class LIB_FLOW_DOCUMENT_API RemoveLayersProperties
    : public AddRemoveLayersProperties {
 public:
