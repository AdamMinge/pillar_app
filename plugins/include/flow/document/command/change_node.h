...
class LIB_FLOW_DOCUMENT_API SetNodesVisible : public ChangeValue<Node, bool> {
 public:
...
class LIB_FLOW_DOCUMENT_API SetNodesName : public ChangeValue<Node, QString> {
 public:
...
class LIB_FLOW_DOCUMENT_API SetNodesPosition
    : public ChangeValue<Node, QPointF> {
 public:
...
class LIB_FLOW_DOCUMENT_API SetNodesCustomProperty
...
class LIB_FLOW_DOCUMENT_API AddRemoveNodesProperties : public pillar::Command {
 public:
...
class LIB_FLOW_DOCUMENT_API AddNodesProperties
...
class LIB_FLOW_DOCUMENT_API RemoveNodesProperties
    : public AddRemoveNodesProperties {
 public:
