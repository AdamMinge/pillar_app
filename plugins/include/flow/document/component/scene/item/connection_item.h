...
class LIB_FLOW_DOCUMENT_API ConnectionGeometry {
...
class LIB_FLOW_DOCUMENT_API ConnectionPainter {
 public:
...
class LIB_FLOW_DOCUMENT_API ConnectionItem : public ObjectItem {
  Q_OBJECT
