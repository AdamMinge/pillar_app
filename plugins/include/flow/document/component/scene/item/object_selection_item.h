...
class LIB_FLOW_DOCUMENT_API ObjectOutlineItem : public QGraphicsItem {
 public:
...
class LIB_FLOW_DOCUMENT_API ObjectSelectionItem : public QGraphicsItem {
 public:
...
class LIB_FLOW_DOCUMENT_API NodeSelectionItem : public QObject,
