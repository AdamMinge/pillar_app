/* ----------------------------------- Local -------------------------------- */
#include "flow/document/component/factories/factories_dock.h"

#include "flow/document/component/factories/factories_tree_model.h"
/* ------------------------------------ Qt ---------------------------------- */
#include <QEvent>
#include <QVBoxLayout>
/* ----------------------------------- Qtils -------------------------------- */
...
/* ------------------------------------ Ui ---------------------------------- */
#include "flow/document/ui_factories_dock.h"
/* -------------------------------------------------------------------------- */
...
FactoriesDock::FactoriesDock(QWidget *parent)
    : FlowDockWidget(parent),
      ...
      m_search_proxy_model(new qtils::QtLeafFilterProxyModel) {
