...
DocumentManager::DocumentManager()
    : m_widget(new QWidget()),
      ...
      m_file_system_watcher(new qtils::QtFileSystemWatcher()),
  ...
  connect(m_file_system_watcher.get(),
          &qtils::QtFileSystemWatcher::pathsChanged, this,
...
bool DocumentManager::saveDocumentAs(Document *document) {
  ...
  const auto file_name = qtils::QtExtendedFileDialog::getSaveFileName(
