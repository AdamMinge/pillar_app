...
LanguageManager::LanguageManager() {
  auto qt_translator = new pillar::BaseLanguageTranslator(
      translations::TranslationsPath, translations::QtBaseTranslationsPrefix,
      this);
  auto pillar_translator = new pillar::BaseLanguageTranslator(
      translations::TranslationsPath, translations::PillarTranslationsPrefix,
      this);

  addedObject(qt_translator);
  addedObject(pillar_translator);
