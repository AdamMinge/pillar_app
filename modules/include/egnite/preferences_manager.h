#ifndef EGNITE_PREFERENCES_MANAGER_H
#define EGNITE_PREFERENCES_MANAGER_H
...
class LIB_EGNITE_API PreferencesSettings {
 public:
...
class LIB_EGNITE_API PreferencesManager : public QObject {
  Q_OBJECT
...
template <typename TYPE>
class LIB_EGNITE_API Preference {
 public:
...
template <typename TYPE>
class LIB_EGNITE_API PreferenceContainer {
 public:
...
#endif  // EGNITE_PREFERENCES_MANAGER_H
