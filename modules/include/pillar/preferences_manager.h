#ifndef PILLAR_PREFERENCES_MANAGER_H
#define PILLAR_PREFERENCES_MANAGER_H
...
class LIB_PILLAR_API PreferencesSettings {
 public:
...
class LIB_PILLAR_API PreferencesManager : public QObject {
  Q_OBJECT
...
template <typename TYPE>
class LIB_PILLAR_API Preference {
 public:
...
template <typename TYPE>
class LIB_PILLAR_API PreferenceContainer {
 public:
...
#endif  // PILLAR_PREFERENCES_MANAGER_H
