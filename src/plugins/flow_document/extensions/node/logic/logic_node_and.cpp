...
void LogicNodeAnd::compute() {
  const auto &in_pin_0 = getPin(flow_document::FlowPin::Type::In, 0);
  const auto &in_pin_1 = getPin(flow_document::FlowPin::Type::In, 1);
  auto &out_pin = getPin(flow_document::FlowPin::Type::Out, 0);
