...
#include <climits>
/* ----------------------------------- Local -------------------------------- */
#include "utils/property_browser/priv/property_browser_utils_p.h"
...
template <typename PRIVATE_DATA, typename Value>
static void setSimpleMinimumData(PRIVATE_DATA *data, const Value &minVal) {
  data->minVal = minVal;
...
template <typename PRIVATE_DATA, typename Value>
static void setSimpleMaximumData(PRIVATE_DATA *data, const Value &maxVal) {
  data->maxVal = maxVal;
...
template <typename PRIVATE_DATA, typename Value>
static void setSizeMinimumData(PRIVATE_DATA *data, const Value &newMinVal) {
...
template <typename PRIVATE_DATA, typename Value>
static void setSizeMaximumData(PRIVATE_DATA *data, const Value &newMaxVal) {
...
template <typename SIZE_VALUE>
static SIZE_VALUE qBoundSize(const SIZE_VALUE &minVal, const SIZE_VALUE &val,
                             const SIZE_VALUE &maxVal) {
  SIZE_VALUE croppedVal = val;
...
template <typename VALUE_CHANGE_PARAMETER, typename VALUE,
          typename PROPERTY_MANAGER>
static void setSimpleValue(
    QMap<const QtProperty *, VALUE> &propertyMap, PROPERTY_MANAGER *manager,
    void (PROPERTY_MANAGER::*propertyChangedSignal)(QtProperty *),
    void (PROPERTY_MANAGER::*valueChangedSignal)(QtProperty *,
                                                 VALUE_CHANGE_PARAMETER),
...
template <typename VALUE_CHANGE_PARAMETER, typename PROPERTY_MANAGER_PRIVATE,
          typename PROPERTY_MANAGER, typename VALUE>
static void setValueInRange(
    PROPERTY_MANAGER *manager, PROPERTY_MANAGER_PRIVATE *managerPrivate,
    void (PROPERTY_MANAGER::*propertyChangedSignal)(QtProperty *),
    void (PROPERTY_MANAGER::*valueChangedSignal)(QtProperty *,
                                                 VALUE_CHANGE_PARAMETER),
    QtProperty *property, const VALUE &val,
    void (PROPERTY_MANAGER_PRIVATE::*setSubPropertyValue)(
        QtProperty *, VALUE_CHANGE_PARAMETER)) {
...
static void setBorderValues(
    ...
    void (PROPERTY_MANAGER::*valueChangedSignal)(QtProperty *,
                                                 VALUE_CHANGE_PARAMETER),
    void (PROPERTY_MANAGER::*rangeChangedSignal)(QtProperty *,
                                                 VALUE_CHANGE_PARAMETER,
                                                 VALUE_CHANGE_PARAMETER),
    QtProperty *property, VALUE_CHANGE_PARAMETER minVal,
    VALUE_CHANGE_PARAMETER maxVal,
    void (PROPERTY_MANAGER_PRIVATE::*setSubPropertyRange)(
        QtProperty *, VALUE_CHANGE_PARAMETER, VALUE_CHANGE_PARAMETER,
        VALUE_CHANGE_PARAMETER)) {
  const auto it = managerPrivate->m_values.find(property);
  if (it == managerPrivate->m_values.end()) return;
...
template <typename VALUE_CHANGE_PARAMETER, typename PROPERTY_MANAGER_PRIVATE,
          typename PROPERTY_MANAGER, typename VALUE, typename PrivateData>
static void setBorderValue(
    ...
    void (PrivateData::*setRangeVal)(VALUE_CHANGE_PARAMETER),
...
static void setMinimumValue(
  ...
  void (PROPERTY_MANAGER_PRIVATE::*setSubPropertyRange)(
      QtProperty *, VALUE_CHANGE_PARAMETER, VALUE_CHANGE_PARAMETER,
      VALUE_CHANGE_PARAMETER) = 0;
  setBorderValue<VALUE_CHANGE_PARAMETER, PROPERTY_MANAGER_PRIVATE,
                 PROPERTY_MANAGER, VALUE, PrivateData>(
      manager, managerPrivate, propertyChangedSignal, valueChangedSignal,
      rangeChangedSignal, property,
      &PROPERTY_MANAGER_PRIVATE::Data::minimumValue,
      &PROPERTY_MANAGER_PRIVATE::Data::setMinimumValue, minVal,
      setSubPropertyRange);
}
...
static void setMaximumValue(
  ...
  setBorderValue<VALUE_CHANGE_PARAMETER, PROPERTY_MANAGER_PRIVATE,
      ...
      manager, managerPrivate, propertyChangedSignal, valueChangedSignal,
      rangeChangedSignal, property,
      &PROPERTY_MANAGER_PRIVATE::Data::maximumValue,
      &PROPERTY_MANAGER_PRIVATE::Data::setMaximumValue, maxVal,
      setSubPropertyRange);
}
...
/*!
  \fn void QtIntPropertyManager::setRange(QtProperty *property, int minimum, int
  maximum)
...
/*!
  ...
  \sa setRegExp()
*/
QRegularExpression QtStringPropertyManager::regExp(
...
/*!
  \fn void QtStringPropertyManager::setValue(QtProperty *property, const QString
  &value)
...
/*!
  \fn void QtDatePropertyManager::valueChanged(QtProperty *property, QDate
  value)
...
/*!
  \fn void QtDatePropertyManager::rangeChanged(QtProperty *property, QDate
  minimum, QDate maximum)
...
void QtDatePropertyManager::setValue(QtProperty *property, QDate val) {
  void (QtDatePropertyManagerPrivate::*setSubPropertyValue)(QtProperty *,
                                                            QDate) = 0;
  setValueInRange<QDate, QtDatePropertyManagerPrivate, QtDatePropertyManager,
                  const QDate>(
...
void QtDatePropertyManager::setMinimum(QtProperty *property, QDate minVal) {
  setMinimumValue<QDate, QtDatePropertyManagerPrivate, QtDatePropertyManager,
                  QDate, QtDatePropertyManagerPrivate::Data>(
      this, d_ptr.data(), &QtDatePropertyManager::propertyChanged,
...
void QtDatePropertyManager::setMaximum(QtProperty *property, QDate maxVal) {
  setMaximumValue<QDate, QtDatePropertyManagerPrivate, QtDatePropertyManager,
                  QDate, QtDatePropertyManagerPrivate::Data>(
      this, d_ptr.data(), &QtDatePropertyManager::propertyChanged,
      &QtDatePropertyManager::valueChanged,
...
/*!
  \fn void QtDatePropertyManager::setRange(QtProperty *property, QDate minimum,
  QDate maximum)
  ...
  \sa setMinimum(), setMaximum(), rangeChanged()
*/
void QtDatePropertyManager::setRange(QtProperty *property, QDate minVal,
                                     QDate maxVal) {
  void (QtDatePropertyManagerPrivate::*setSubPropertyRange)(QtProperty *, QDate,
                                                            QDate, QDate) = 0;
  setBorderValues<QDate, QtDatePropertyManagerPrivate, QtDatePropertyManager,
                  QDate>(this, d_ptr.data(),
...
/*!
  \fn void QtTimePropertyManager::valueChanged(QtProperty *property, QTime
  value)
...
/*!
  \fn void QtCharPropertyManager::valueChanged(QtProperty *property, const QChar
  &value)
...
QString QtLocalePropertyManager::valueText(const QtProperty *property) const {
  ...
  if (langIdx < 0) {
    qWarning("QtLocalePropertyManager::valueText: Unknown language %d",
             loc.language());
    return tr("<Invalid>");
  }
...
/*!
  \fn void QtLocalePropertyManager::setValue(QtProperty *property, const QLocale
  &value)
...
/*!
  \fn void QtPointFPropertyManager::setValue(QtProperty *property, const QPointF
  &value)
...
/*!
  \fn void QtSizePropertyManager::valueChanged(QtProperty *property, const QSize
  &value)
...
/*!
  \fn void QtSizePropertyManager::rangeChanged(QtProperty *property, const QSize
...
class QtSizeFPropertyManagerPrivate {
 ...
 public:
  ...
  struct Data {
    QSizeF val{0, 0};
    QSizeF minVal{0, 0};
    QSizeF maxVal{std::numeric_limits<qreal>::max(),
...
/*!
  \fn void QtRectPropertyManager::valueChanged(QtProperty *property, const QRect
  &value)
...
/*!
  \fn void QtRectPropertyManager::constraintChanged(QtProperty *property, const
  QRect &constraint)
...
/*!
  \fn void QtRectFPropertyManager::constraintChanged(QtProperty *property, const
  QRectF &constraint)
...
/*!
  ...
  Each enum value can have associated icon. This association is represented with
  passed \a enumIcons map.
...
/*!
  \fn void QtSizePolicyPropertyManager::valueChanged(QtProperty *property, const
  QSizePolicy &value)
...
/*!
  \fn void QtFontPropertyManager::valueChanged(QtProperty *property, const QFont
  &value)
...
/*!
  \fn void QtCursorPropertyManager::setValue(QtProperty *property, const QCursor
  &value)
...
#include "utils/property_browser/moc_property_manager.cpp"
#include "utils/property_browser/property_manager.moc"
