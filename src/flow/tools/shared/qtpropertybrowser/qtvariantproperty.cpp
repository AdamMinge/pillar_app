...
#include "flow/tools/shared/qtpropertybrowser/qtvariantproperty.h"
#include "flow/tools/shared/qtpropertybrowser/qtpropertymanager.h"
#include "flow/tools/shared/qtpropertybrowser/qteditorfactory.h"
...
Q_DECLARE_METATYPE(tools::QtEnumPropertyType)
Q_DECLARE_METATYPE(tools::QtFlagPropertyType)
Q_DECLARE_METATYPE(tools::QtGroupPropertyType)
...
#include "flow/tools/shared/qtpropertybrowser/moc_qtvariantproperty.cpp"
