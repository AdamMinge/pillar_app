/* ----------------------------------- Local -------------------------------- */
#include "flow/plugins/flow_document/component/type_converter/flow_type_converters_dock.h"

#include "flow/plugins/flow_document/component/type_converter/flow_type_converters_tree_delegate.h"
#include "flow/plugins/flow_document/component/type_converter/flow_type_converters_tree_model.h"
/* ------------------------------------ Qt ---------------------------------- */
#include <QEvent>
#include <QVBoxLayout>
/* ------------------------------------ Ui ---------------------------------- */
#include "flow_document/ui_flow_converters_dock.h"
/* -------------------------------------------------------------------------- */
...
FlowConvertersDock::FlowConvertersDock(QWidget *parent)
    : QDockWidget(parent),
      m_ui(new Ui::FlowConvertersDock()),
