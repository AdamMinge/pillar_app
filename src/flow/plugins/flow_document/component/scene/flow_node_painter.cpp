/* ----------------------------------- Local -------------------------------- */
#include "flow/plugins/flow_document/component/scene/flow_node_painter.h"

#include "flow/plugins/flow_document/component/scene/flow_node_geometry.h"
#include "flow/plugins/flow_document/component/scene/flow_node_item.h"
#include "flow/plugins/flow_document/component/scene/flow_style_manager.h"
...
void FlowNodePainter::paint(QPainter *painter,
...
void FlowNodePainter::paintNodeRect(QPainter *painter,
                                    const QStyleOptionGraphicsItem *option) {
...
void FlowNodePainter::paintNodeLabel(QPainter *painter,
                                     const QStyleOptionGraphicsItem *option) {
  const auto &node_style = getNodeStyle(m_node_item);
...
void FlowNodePainter::paintNodePins(QPainter *painter,
                                    const QStyleOptionGraphicsItem *option) {
