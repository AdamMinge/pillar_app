/* ----------------------------------- Local -------------------------------- */
#include "flow/plugins/flow_document/component/scene/flow_style_reader.h"
...
class FlowStyleReader::FlowStyleReaderImpl {
 ...
 private:
  ...
  void readNodeStyle(NodeStyle &style, NodeStyle::State state,
                     const QJsonObject &object);
  void readPinStyle(PinStyle &style, PinStyle::State state,
                    const QJsonObject &object);
