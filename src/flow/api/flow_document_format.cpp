...
namespace api
{
  ...
  IReadableFlowDocumentFormat::Capabilities
  IReadableFlowDocumentFormat::getCapabilities() const
  {
  ...
  IWritableFlowDocumentFormat::load(const QString &file_name, QString *error)
  {
  ...
  IWritableFlowDocumentFormat::Capabilities
  IWritableFlowDocumentFormat::getCapabilities() const
  {
