...
public:
  ...
  [[nodiscard]] QVariant
  value(const QString &key, const QVariant &defaultValue) const override;
...
void SessionPreferencesSettings::setValue(
  const QString &key, const QVariant &value)
{
  m_settings.setValue(key, value);
}

QVariant SessionPreferencesSettings::value(
...
TemporaryPreferencesSettings::Type TemporaryPreferencesSettings::getType() const
{
  return Type::Temporary;
}

void TemporaryPreferencesSettings::setValue(
  const QString &key, const QVariant &value)
{
