...
void ProjectWindow::projectChanged(api::IProject *project)
{
...
void ProjectWindow::initConnections()
{
  ...
  connect(&getProjectManager(), &ProjectManager::currentProjectChanged, this, &ProjectWindow::projectChanged);
