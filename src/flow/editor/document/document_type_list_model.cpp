...
QString DocumentTypeListModel::getDocumentNameForType(Document::Type type)
{
  switch (type)
  {
    case Document::Type::Flow:
      return tr("Flow");
...
QIcon DocumentTypeListModel::getDocumentIconForType(Document::Type type)
{
  switch (type)
  {
    case Document::Type::Flow:
