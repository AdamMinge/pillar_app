...
void NewDocumentWidgetListDelegate::paint(QPainter *painter,
  ...
  auto text_rect = content_rect.adjusted(
      ...
      static_cast<int>((content_rect.top() + m_icon_size.height() -
                        opt.font.pointSize() * 1.4) /
                       2),
      0, 0);
...
void NewDocumentWidgetListDelegate::setSpacing(int vertical_spacing,
