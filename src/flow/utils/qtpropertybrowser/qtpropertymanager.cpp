...
#include <climits>
/* ----------------------------------- Local -------------------------------- */
#include "flow/utils/qtpropertybrowser/priv/qtpropertybrowserutils_p.h"
#include "flow/utils/qtpropertybrowser/qtpropertymanager.h"
/* -------------------------------------------------------------------------- */
...
#include "flow/utils/qtpropertybrowser/moc_qtpropertymanager.cpp"
#include "flow/utils/qtpropertybrowser/qtpropertymanager.moc"
