...
*/
  ...
  void
  QtVariantPropertyManagerPrivate::slotPropertyRemoved(QtProperty *property,
                                                       QtProperty *parent)
  {
    Q_UNUSED(parent);
  ...
  void
  QtVariantPropertyManagerPrivate::slotSingleStepChanged(QtProperty *property,
                                                         int step)
  {
    if (QtVariantProperty *varProp = m_internalToProperty.value(property, 0))
  ...
  void
  QtVariantPropertyManagerPrivate::slotDecimalsChanged(QtProperty *property,
                                                       int prec)
  {
    if (QtVariantProperty *varProp = m_internalToProperty.value(property, 0))
      emit q_ptr->attributeChanged(varProp, m_decimalsAttribute,
                                   QVariant(prec));
  }
  ...
  {
    if (QtVariantProperty *varProp = m_internalToProperty.value(property, 0))
      emit q_ptr->attributeChanged(varProp, m_regExpAttribute,
                                   QVariant(regExp));
  }
  ...
  void
  QtVariantPropertyManagerPrivate::slotValueChanged(QtProperty *property,
...
*/
        ...
        d_ptr(new QtVariantPropertyManagerPrivate)
  {
    ...
    connect(doublePropertyManager,
            SIGNAL(singleStepChanged(QtProperty *, double)), this,
    ...
    connect(datePropertyManager,
            SIGNAL(rangeChanged(QtProperty *, QDate, QDate)), this,
    ...
    connect(dateTimePropertyManager,
            SIGNAL(valueChanged(QtProperty *, QDateTime)), this,
    ...
    connect(sizePropertyManager,
            SIGNAL(rangeChanged(QtProperty *, QSize, QSize)), this,
    ...
    connect(sizeFPropertyManager,
            SIGNAL(rangeChanged(QtProperty *, QSizeF, QSizeF)), this,
    ...
    connect(rectFPropertyManager,
            SIGNAL(constraintChanged(QtProperty *, QRectF)), this,
    ...
    connect(flagPropertyManager,
            SIGNAL(flagNamesChanged(QtProperty *, QStringList)), this,
...
*/
  ...
  QtVariantPropertyManager::variantProperty(const QtProperty *property) const
  {
    const QMap<const QtProperty *,
               QPair<QtVariantProperty *, int>>::const_iterator it =
...
*/
  QVariant
  QtVariantPropertyManager::attributeValue(const QtProperty *property,
                                          ...
                                          const QVariant &val)
  {
                 ...
                 qobject_cast<QtDateTimePropertyManager *>(manager))
    {
      ...
      return;
                 ...
                 qobject_cast<QtKeySequencePropertyManager *>(manager))
    {
      keySequenceManager->setValue(internProp,
                                   qvariant_cast<QKeySequence>(val));
      return;
    } else if (QtCharPropertyManager *charManager =
                 qobject_cast<QtCharPropertyManager *>(manager))
    {
...
*/
                                              ...
                                              const QVariant &value)
  {
    ...
    {
      if (attribute == d_ptr->m_regExpAttribute)
        stringManager->setRegExp(internProp,
                                 qvariant_cast<QRegularExpression>(value));
      return;
    } else if (QtDatePropertyManager *dateManager =
                 qobject_cast<QtDatePropertyManager *>(manager))
    {
    ...
    {
      if (attribute == d_ptr->m_enumNamesAttribute)
        enumManager->setEnumNames(internProp,
                                  qvariant_cast<QStringList>(value));
      if (attribute == d_ptr->m_enumIconsAttribute)
    ...
    {
      if (attribute == d_ptr->m_flagNamesAttribute)
        flagManager->setFlagNames(internProp,
                                  qvariant_cast<QStringList>(value));
      return;
    }
  }
...
*/
  QtProperty *QtVariantPropertyManager::createProperty()
  {
    ...
    d_ptr->m_propertyToType.insert(property,
                                   qMakePair(property, d_ptr->m_propertyType));
...
*/
  QWidget *
  QtVariantEditorFactory::createEditor(QtVariantPropertyManager *manager,
