...
namespace utils
{
  ...
  QAction *createActionWithShortcut(
    const QIcon &icon, QString &text, const QKeySequence &key_sequence,
    QObject *parent)
  {
  ...
  QAction *createActionWithShortcut(
    const QString &text, const QKeySequence &key_sequence, QObject *parent)
  {
  ...
  QAction *
  createActionWithShortcut(const QKeySequence &key_sequence, QObject *parent)
  {
