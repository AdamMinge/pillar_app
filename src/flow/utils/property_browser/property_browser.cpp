...
#include <QtGui/QIcon>
/* ----------------------------------- Local -------------------------------- */
#include "flow/utils/property_browser/property_browser.h"
/* -------------------------------------------------------------------------- */
...
/*!
  ...
  \snippet
  doc/src/snippets/code/tools_shared_qtpropertybrowser_qtpropertybrowser.cpp 0
  ...
  make this factory stop producing editors for a given property manager. Use the
  propertyManagers() function to retrieve the set of managers currently
...
/*!
  ...
  \snippet
  doc/src/snippets/code/tools_shared_qtpropertybrowser_qtpropertybrowser.cpp 1
...
void QtAbstractPropertyBrowserPrivate::insertSubTree(
  ...
  for (QtProperty *subProperty : subList) insertSubTree(subProperty, property);
}
...
void QtAbstractPropertyBrowserPrivate::removeSubTree(
  ...
  const auto subList = property->subProperties();
  for (QtProperty *subProperty : subList) removeSubTree(subProperty, property);
}
...
/*!
  ...
  \li
  \snippet
  doc/src/snippets/code/tools_shared_qtpropertybrowser_qtpropertybrowser.cpp 2
...
/*!
  ...
  *manager, QtAbstractEditorFactory<PropertyManager> *factory)
  ...
  \snippet
  doc/src/snippets/code/tools_shared_qtpropertybrowser_qtpropertybrowser.cpp 3
...
QWidget *QtAbstractPropertyBrowser::createEditor(QtProperty *property,
  ...
  // Since some editors can be QComboBoxes, and we changed their focus policy in
  // Qt 5 to make them feel more native on Mac, we need to relax the focus
  // policy to something more permissive to keep the combo box from losing
  // focus, allowing it to stay alive, when the user clicks on it to show the
  // popup.
...
#include "flow/utils/property_browser/moc_property_browser.cpp"
