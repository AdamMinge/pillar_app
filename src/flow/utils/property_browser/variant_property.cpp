...
#include <QtGui/QIcon>
/* ----------------------------------- Local -------------------------------- */
#include "flow/utils/property_browser/editor_factory.h"
#include "flow/utils/property_browser/property_manager.h"
#include "flow/utils/property_browser/variant_property.h"
/* -------------------------------------------------------------------------- */
...
/*!
  ...
  \snippet
  doc/src/snippets/code/tools_shared_qtpropertybrowser_qtvariantproperty.cpp 0

  you can write:

  \snippet
  doc/src/snippets/code/tools_shared_qtpropertybrowser_qtvariantproperty.cpp 1
...
/*!
  ...
  \brief The QtVariantPropertyManager class provides and manages QVariant based
  properties.
...
/*!
  \fn void QtVariantPropertyManager::valueChanged(QtProperty *property, const
  QVariant &value)
...
QtVariantPropertyManager::QtVariantPropertyManager(QObject *parent)
  ...
  d_ptr->m_typeToAttributeToAttributeType[QMetaType::QDate]
                                         [d_ptr->m_maximumAttribute] =
      QMetaType::QDate;
  connect(datePropertyManager, SIGNAL(valueChanged(QtProperty *, QDate)), this,
  ...
  connect(timePropertyManager, SIGNAL(valueChanged(QtProperty *, QTime)), this,
  ...
  connect(charPropertyManager, SIGNAL(valueChanged(QtProperty *, QChar)), this,
  ...
  d_ptr->m_typeToAttributeToAttributeType[QMetaType::QSize]
                                         [d_ptr->m_maximumAttribute] =
      QMetaType::QSize;
  connect(sizePropertyManager, SIGNAL(valueChanged(QtProperty *, QSize)), this,
  ...
  d_ptr->m_typeToAttributeToAttributeType[QMetaType::QRect]
      ...
      QMetaType::QRect;
  connect(rectPropertyManager, SIGNAL(valueChanged(QtProperty *, QRect)), this,
  ...
  connect(fontPropertyManager, SIGNAL(valueChanged(QtProperty *, QFont)), this,
...
/*!
  \fn void QtVariantPropertyManager::setValue(QtProperty *property, const
  QVariant &value)
...
#include "flow/utils/property_browser/moc_variant_property.cpp"
