...
void QtDateEditFactoryPrivate::slotRangeChanged(QtProperty *property, QDate min,
                                                QDate max) {
  const auto it = m_createdEditors.constFind(property);
  if (it == m_createdEditors.constEnd()) return;
...
#include "flow/utils/property_browser/editor_factory.moc"
#include "flow/utils/property_browser/moc_editor_factory.cpp"
