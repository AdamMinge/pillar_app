...
/* ----------------------------------- Local -------------------------------- */
#include "flow/utils/property_browser/button_property_browser.h"
/* -------------------------------------------------------------------------- */
...
class QtButtonPropertyBrowserPrivate {
 ...
 public:
  ...
  struct WidgetItem {
    ...
    QLabel *widgetLabel{nullptr};  // label substitute showing the current value
...
QToolButton *QtButtonPropertyBrowserPrivate::createButton(
  ...
  QIcon::Normal, QIcon::On); button->setIcon(icon);
  */
  return button;
}
...
/*!
  ...
  the drop down button. The parent property's name is displayed as button text.
  For example:
...
/*!
  Sets the \a item to either collapse or expanded, depending on the value of \a
  expanded.
...
#include "flow/utils/property_browser/moc_button_property_browser.cpp"
